package com.maxiee.attitude.common.tagview;
...
public class Tag {
    ...
    public Tag(String text) {
        init(
                0,
                text, Constants.DEFAULT_TAG_TEXT_COLOR,
    ...
    private void init(int id,
                      ...
                      float tagTextSize,
                      int layout_color,
                      int layout_color_press,
                      boolean isDeletable,
                      int deleteIndicatorColor,
                      float deleteIndicatorSize,
                      float radius,
                      String deleteIcon,
                      float layoutBorderSize,
                      int layoutBorderColor) {
        this.id = id;
        this.text = text;
